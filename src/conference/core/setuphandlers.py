...
_PROJECT = 'conference.core'
_PROFILE_ID = 'conference.core:default'


@gs.importstep(name=u'conference.core',
               title='Run upgrades for conference.core',
               description='Run upgrades for conference.core.')
def run_upgrades(context):
    """ Run Upgrade steps
    """
    if context.readDataFile('conference.core-default.txt') is None:
        return
